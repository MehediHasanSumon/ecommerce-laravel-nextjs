...
const defaultCompanySettings: CompanySettings = {
  company_name: "LuxeCart Commerce Ltd.",
  company_short_name: "LuxeCart",
  company_tagline: "Premium commerce operations, simplified.",
  company_description: "LuxeCart powers curated retail operations with catalog, inventory, marketing, and fulfillment workflows.",
  company_email: "hello@luxecart.test",
  company_phone: "+880 2 5500 1234",
  company_mobile: "+880 1711 000000",
  website: "https://luxecart.test",
  logo: "settings/branding/logo-light.webp",
  dark_logo: "settings/branding/logo-dark.webp",
  favicon: "settings/branding/favicon.ico",
  login_page_logo: "settings/branding/login-logo.webp",
  admin_logo: "settings/branding/admin-logo.webp",
  admin_favicon: "settings/branding/admin-favicon.ico",
  address: "House 12, Road 8, Gulshan",
  city: "Dhaka",
  state: "Dhaka",
  postal_code: "1212",
  country: "Bangladesh",
  trade_license: "TRD-2026-00041",
  tin: "TIN-984512367",
  bin: "BIN-002614598",
  invoice_prefix: "INV",
  invoice_start: 1000,
  invoice_footer_text: "Thank you for shopping with LuxeCart.",
  invoice_terms: "Returns are accepted within 7 days for eligible products in original condition.",
  invoice_logo: "settings/invoice/logo.webp",
  invoice_signature: "settings/invoice/signature.webp",
  currency_id: "",
  ...
  support_phone: "+880 9612 000000",
  whatsapp_number: "+880 1711 000001",
  telegram: "luxecart_support",
  messenger: "luxecart",
  facebook: "https://facebook.com/luxecart",
  instagram: "https://instagram.com/luxecart",
  youtube: "https://youtube.com/@luxecart",
  twitter: "https://x.com/luxecart",
  linkedin: "https://linkedin.com/company/luxecart",
  meta_title: "LuxeCart | Premium eCommerce",
  meta_description: "Shop premium products with fast fulfillment and secure checkout.",
  meta_keywords: "ecommerce, fashion, electronics, home, bangladesh",
  ...
  maintenance_message: "We are upgrading the store. Please check back shortly.",
};
