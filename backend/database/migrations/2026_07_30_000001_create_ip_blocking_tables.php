...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('security_settings', function (Blueprint $table): void {
            ...
            $table->unsignedSmallInteger('max_otp_attempts')->default(8);
            $table->unsignedSmallInteger('max_registration_attempts')->default(5);
            $table->unsignedInteger('max_api_requests')->default(600);
            $table->unsignedSmallInteger('max_checkout_requests')->default(20);
            $table->unsignedSmallInteger('max_contact_submissions')->default(10);
            $table->unsignedSmallInteger('max_invalid_auth_attempts')->default(20);
            $table->unsignedSmallInteger('max_payment_failures')->default(8);
            $table->unsignedSmallInteger('max_not_found_requests')->default(40);
            $table->unsignedSmallInteger('max_bot_requests')->default(120);
