...
export const productModuleConfigs: Record<ProductModule, ModuleConfig> = {
  ...
  categories: {
    ...
    fields: [
      ...
      { name: "name", label: "Name", type: "text" },
      { name: "description", label: "Description", type: "textarea", optional: true },
      { name: "image_file", label: "Category Image", type: "file", optional: true, existingImageField: "image_url", accept: "image/jpeg,image/png,image/webp", allowedTypes: ["image/jpeg", "image/png", "image/webp"], helperText: "JPG, PNG, or WebP up to 4MB. Drag and drop or click to browse.", maxSizeMb: 4 },
      { name: "icon_file", label: "Icon", type: "file", optional: true, existingImageField: "icon", accept: "image/jpeg,image/png,image/webp", allowedTypes: ["image/jpeg", "image/png", "image/webp"], helperText: "JPG, PNG, or WebP up to 1MB. Drag and drop or click to browse.", maxSizeMb: 1 },
      { tab: "SEO", name: "meta_title", label: "Meta Title", type: "text", optional: true },
      { tab: "SEO", name: "meta_description", label: "Meta Description", type: "textarea", optional: true },
      { tab: "SEO", name: "meta_keywords", label: "Meta Keywords", type: "textarea", optional: true },
      { tab: "SEO", name: "canonical_url", label: "Canonical URL", type: "text", optional: true },
