...
const adminPermissionAliases: Record<string, string> = {
  ...
  "warehouses.view": "can_view_warehouse",
  ...
  "email-settings.view": "can_view_email_setting",
  "sms-settings.view": "can_view_sms_setting",
...
const adminRoutePermissions: Record<string, string> = {
  ...
  [routePaths.adminWarehouses]: "can_view_warehouse",
  ...
  [routePaths.adminSettingsEmail]: "can_view_email_setting",
