...
class UpdateSecuritySettingsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'enable_checkout_security' => ['required', 'boolean'],
            'enable_cod_security' => ['required', 'boolean'],
            'enable_payment_security' => ['required', 'boolean'],
            'auto_block_critical_ips' => ['required', 'boolean'],
            ...
            'failed_cod_threshold' => ['required', 'integer', 'min:1', 'max:1000'],
